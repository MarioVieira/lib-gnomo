package uk.co.baremedia.gnomo.enums
{
	public class EnumsLocalNetwork
	{
		...
		public static const TYPE_IOS				:String = "typeMobileIOS";
		public static const GROUP_FEEDBACK_RESPONSE :String = "groupFeedbackResponse";
		public static const MONITOR_REQUEST_RESPONSE:Number 	= 1000; //1sec
		public static const MONITOR_REQUEST_TIMEOUT:Number 		= 3000;
		public static const ACTIVE_BROADCASTER_CHECK:String	= "activeBroacasterCheck";
	}
}